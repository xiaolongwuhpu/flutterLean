...
//        child: Image.network(list[index],fit: BoxFit.cover,)
  ...
  void initState() {
    ...
    if(widget.list==null || widget.list.length==0){
     list.add("https://dmpcdn.ksmobile.com/cloud/test/1608/cS7O2FLV2H_1554801266/z1A7xMZjTJ_1554806785/m33IV3T6ddYB0f97WY4rS30XzsLYu8Az_1555579051.jpg");
     list.add("https://dmpcdn.ksmobile.com/cloud/test/1608/O6QzWnjc0N_1552298403/ZIcLVg8dpI_1555579146/Z86Y8Ex1cfy72l6Pa9B7d4oq2Vk468tz_1555580719.jpg");
     list.add("https://dmpcdn.ksmobile.com/cloud/test/1608/O6QzWnjc0N_1552298403/6K947tJUvg_1555579159/U2386G633mGb9o2ZgwAKTgZZ4hjSmVUh_1555580573.jpg");
    }else{
       list=widget.list;
    }
